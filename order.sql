...
VALUES
  (
    ...
    '',
    '40001',
    '[{"id":201,"image":"/product/2024-09-13-161849.png","name":"手剥鲜石榴茉莉","attribute":"中杯/7分糖/正常冰","num":1,"price":16}]'
  );
...
INSERT INTO
  `product_type` (`id`, `name`, `img`)
VALUES
  ('101', '新品来袭', '/type/xinpin.png'),
  ('102', '水果茶', '/type/shuiguocha.png'),
  ('103', '醇香奶茶', '/type/naicha.png'),
  ('104', '牛乳茶', '/type/niunai.png'),
  ('105', '沁爽柠檬茶', '/type/ningmeng.png'),
  ('106', '轻松现泡茶', '/type/cha.png'),
  ('107', '豪气1L装', '/type/chaoda.png'),
  ('108', '加小料区', '');
